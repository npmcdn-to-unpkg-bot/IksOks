...
require('rxjs/Rx');
var ViewPlayersComponent = (function () {
    function ViewPlayersComponent(builder, http, router, routeParams) {
        this.http = http;
        this.router = router;
        this.routeParams = routeParams;
    }
    ViewPlayersComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ViewPlayersComponent = __decorate([
        core_1.Component({
    ...
    return ViewPlayersComponent;
}());
exports.ViewPlayersComponent = ViewPlayersComponent;
//# sourceMappingURL=view_players.component.js.map